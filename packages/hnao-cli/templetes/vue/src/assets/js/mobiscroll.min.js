  ...
  var ms = $.mobiscroll,
    ...
    preset = function (inst) {
      ...
      var s = $.extend({}, defaults, html5def, inst.settings),
        ...
        hformat =
          p == 'datetime'
            ? s.dateFormat + s.separator + s.timeFormat
            : p == 'time'
              ? s.timeFormat
              : s.dateFormat,
        defd = new Date(),
          ...
          if (k == o.y) {
            ...
            for (i = 0; i < 12; i++) {
              ...
              w[s.monthText][i] = str.match(/MM/)
                ? str.replace(
                  /MM/,
                  '<span class="dw-mon">' + s.monthNames[i] + '</span>'
                )
                : str.replace(
                  /M/,
                  '<span class="dw-mon">' + s.monthNamesShort[i] + '</span>'
                )
            }
          } else if (k == o.d) {
            offset++
        ...
        for (k = offset; k < offset + 4; k++) {
          if (k == o.h) {
            ...
            for (i = 0; i < (hampm ? 12 : 24); i += stepH) {
              w[s.hourText][i] =
                hampm && i == 0 ? 12 : tord.match(/hh/i) && i < 10 ? '0' + i : i
            }
          } else if (k == o.i) {
            offset++
            w[s.minuteText] = {}
        ...
        validate: function (dw, i) {
          ...
          $.each(['y', 'm', 'd', 'a', 'h', 'i', 's'], function (x, i) {
            if (o[i] !== undefined) {
                  ...
                  $('.dw-li', t).each(function () {
                    ...
                    $('.dw-i', that).html(
                      str.match(/DD/)
                        ? str.replace(
                          /DD/,
                          '<span class="dw-day">' + s.dayNames[w] + '</span>'
                        )
                        : str.replace(
                          /D/,
                          '<span class="dw-day">' +
              ...
              if (i != 'y') {
                var i1 = $('.dw-li', t).index(
                    $('.dw-li[data-val="' + min + '"]', t)
                  ),
                  i2 = $('.dw-li', t).index(
                    $('.dw-li[data-val="' + max + '"]', t)
                  )
                $('.dw-li', t)
                  .removeClass('dw-v')
                  .slice(i1, i2 + 1)
