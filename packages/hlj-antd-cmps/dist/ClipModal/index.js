  ...
  function _default() {
    ...
    return (
      (_ret = ((_temp = ((_this = _possibleConstructorReturn(
        this,
        (_ref =
          _default.__proto__ || Object.getPrototypeOf(_default)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
      _this)),
      (_this.clipInfo = {}),
      (_this.onComplete = function(data, url, index) {
        return function(crop, pixelCrop) {
          ...
          _this.clipInfo = {
            ...
            clipUrl:
              removeSuffix(url) +
              ("?imageMogr2/crop/!" + width + "x" + height + "a" + x + "a" + y),
            pixel: pixelCrop
          };
        };
      }),
  ...
  _createClass(_default, [
    {
      ...
      value: function render() {
        ...
        var _aspect =
          typeof aspect === "function" ? aspect(img, index) : aspect;
        var _clipConfig =
          typeof clipConfig === "function"
            ? clipConfig(img, index)
            : clipConfig;
