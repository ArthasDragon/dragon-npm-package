...
import "./style.css"
const styles = {"container":"_container_zg6fh_1","record":"_record_zg6fh_9","header":"_header_zg6fh_13","content":"_content_zg6fh_25","empty_record":"_empty_record_zg6fh_35"};
  ...
  _createClass(_default, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        "div",
        { style: _extends({ maxHeight: maxHeight }, style), className: styles.container },
        recordList.length ? recordList.map(function (item) {
          return React.createElement(
            "div",
