...
var HButtonGroup = (_temp2 = _class = function (_PureComponent) {
  ...
  function HButtonGroup() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = HButtonGroup.__proto__ || Object.getPrototypeOf(HButtonGroup)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
    ...
    value: function render() {
      ...
      if (items.length > overCount) {
        ...
        var menu = React.createElement(
          ...
          items.slice(overCount).map(function (item) {
            var text = item.text,
                ...
                disabled = _item$disabled2 === undefined ? false : _item$disabled2;
        ...
        overItems = React.createElement(
          ...
          React.createElement(
            Button,
            { icon: 'down', type: activeIndex >= overCount ? 'primary' : 'default' },
